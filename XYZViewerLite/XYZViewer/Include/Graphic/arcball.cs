...
namespace Automation
{
    ...
    public class arcball
    {
        ...
        public void drag_rotation(Point NewPt, Quat4f NewRot)
        {
        ...
        //Mouse drag, calculate move
        //public void drag_move(Point NewPt, Vector3f MoveVec)
        //{
        //    //Map the point to the sphere
        //    this.mapToSphere(NewPt, EnVec);
            
        //    //Compute the vector from the begin and end vectors
        //    MoveVec.x = EnVec.x - StVec.x;
        //    MoveVec.y = EnVec.y - StVec.y;
        //    MoveVec.z = EnVec.z - StVec.z;  
        //}
